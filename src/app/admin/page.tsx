        ...
        <Tabs defaultValue="menu" className="w-full">
          ...
          <TabsContent value="settings">
            <Card className="shadow-lg">
              <CardHeader><CardTitle>Token Settings</CardTitle><CardDescription>Control the token booking system.</CardDescription></CardHeader>
              <CardContent className="space-y-6">
                <div className="flex items-center justify-between space-x-2 p-4 border rounded-lg">
                  <Label htmlFor="booking-active" className="font-bold text-lg">Booking Active</Label>
                  <Switch id="booking-active" checked={tokenSettings?.isActive} onCheckedChange={(checked) => setTokenSettings(s => s ? {...s, isActive: checked} : null)} />
                </div>
              ...
              <CardFooter className="border-t pt-6 flex-col sm:flex-row gap-4">
                 ...
                 <AlertDialog>
                   ...
                   <AlertDialogContent>
                     <AlertDialogHeader><AlertDialogTitle>Are you sure?</AlertDialogTitle><AlertDialogDescription>This will delete all existing bookings and reset the token count for a new day. This action cannot be undone.</AlertDialogDescription></AlertDialogHeader>
                     <div className="py-2">
          ...
          <TabsContent value="bookings">
            <Card className="shadow-lg">
                <CardHeader><CardTitle>Today's Bookings</CardTitle><CardDescription>All tokens booked for the special Biriyani today.</CardDescription></CardHeader>
                <CardContent>
                    <Table>
                        <TableHeader>
                            <TableRow>
